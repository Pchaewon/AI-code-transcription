...
const __PT_COLORS={'13.3Hr':'#0f5c8c','18.5Hr':'#d9772d'};
...
function lotTrendChart(blocks,color,opts){
  ...
  Object.keys(byPt).forEach(pt=>{
    ...
    traces.push({
      x:g.x, y:g.y, customdata:g.cd, mode:'markers+lines', type:'scatter',
      name:(pt&&pt!=='_')?pt:'', marker:{color:c,size:6}, line:{color:c,width:1.4},
      connectgaps:false,
